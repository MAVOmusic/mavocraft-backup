...
| 8 | `08-tutorial-ch11-museum.png` | Museum counts + unsellable items | RESOLVED (guide: 103 sections / 1,413 items; /museum shopsgen writes a real ESGUI section+shop pair; run `/sreload`) |
