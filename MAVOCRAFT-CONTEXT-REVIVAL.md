...
- **MAVOProfessions (harder):** lumberjack `xp-base` 350 -> 600, `xp-growth` 1.035 -> 1.04 (~170 trees per early level with the 10-log cap). Other professions untouched (Gambler/Sleeper rebalances stay).
